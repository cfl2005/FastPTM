...
# 12模型 1机20组
python workers.py --task=omls --machine=1 --taskfile=../task_data/g3/167288556143_dat_T240_L12_M0.05.json
sleep 5

python workers.py --task=fcfs --machine=1 --taskfile=../task_data/g3/167288556143_dat_T240_L12_M0.05.json
sleep 5
...
# 6模型 1机20组
python workers.py --task=omls --machine=1 --taskfile=../task_data/g3/167288556057_dat_T120_L6_M0.05.json
sleep 5

python workers.py --task=fcfs --machine=1 --taskfile=../task_data/g3/167288556057_dat_T120_L6_M0.05.json
sleep 5
...
# 12模型 2机20组
python workers.py --task=omls --machine=2 --taskfile=../task_data/g3/167288556143_dat_T240_L12_M0.05.json
sleep 5

python workers.py --task=fcfs --machine=2 --taskfile=../task_data/g3/167288556143_dat_T240_L12_M0.05.json
sleep 5
...
# 6模型 2机20组
python workers.py --task=omls --machine=2 --taskfile=../task_data/g3/167288556057_dat_T120_L6_M0.05.json
sleep 5

python workers.py --task=fcfs --machine=2 --taskfile=../task_data/g3/167288556057_dat_T120_L6_M0.05.json
sleep 5
...
# 12模型 3机20组
python workers.py --task=omls --machine=3 --taskfile=../task_data/g3/167288556143_dat_T240_L12_M0.05.json
sleep 5

python workers.py --task=fcfs --machine=3 --taskfile=../task_data/g3/167288556143_dat_T240_L12_M0.05.json
sleep 5
...
# 6模型 3机20组
python workers.py --task=omls --machine=3 --taskfile=../task_data/g3/167288556057_dat_T120_L6_M0.05.json
sleep 5

python workers.py --task=fcfs --machine=3 --taskfile=../task_data/g3/167288556057_dat_T120_L6_M0.05.json
sleep 5
